...
#ifndef COM_ONESIGNAL_CLIENT_MODEL_MultipartFormData_H_
#define COM_ONESIGNAL_CLIENT_MODEL_MultipartFormData_H_
...
#endif /* COM_ONESIGNAL_CLIENT_MODEL_MultipartFormData_H_ */
