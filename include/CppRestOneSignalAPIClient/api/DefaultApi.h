...
public:
    ...
    virtual pplx::task<std::shared_ptr<Inline_response_200_4>> createPlayer(
    ...
    virtual pplx::task<std::shared_ptr<Inline_response_200_1>> deletePlayer(
        utility::string_t appId,
        utility::string_t playerId
    ) const = 0;
    virtual pplx::task<std::shared_ptr<Inline_response_200_3>> deleteSegments(
        utility::string_t appId,
        utility::string_t segmentId
    ) const = 0;
    virtual pplx::task<std::shared_ptr<Inline_response_200_5>> exportPlayers(
        utility::string_t appId,
    ...
    virtual pplx::task<utility::string_t> getApps(
    ) const = 0;
    virtual pplx::task<std::shared_ptr<Notification>> getNotification(
        utility::string_t appId,
        utility::string_t notificationId
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<Inline_response_200_3>> updatePlayerTags(
        utility::string_t appId,
...
public:
    ...
    pplx::task<std::shared_ptr<Inline_response_200_4>> createPlayer(
        std::shared_ptr<Player> player
    ) const override;
    /// <summary>
    /// Create Segments
    ...
    pplx::task<std::shared_ptr<Inline_response_200_1>> deletePlayer(
        utility::string_t appId,
        utility::string_t playerId
    ) const override;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Inline_response_200_3>> deleteSegments(
        utility::string_t appId,
        utility::string_t segmentId
    ) const override;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Inline_response_200_5>> exportPlayers(
        utility::string_t appId,
        boost::optional<std::shared_ptr<Export_players_request_body>> exportPlayersRequestBody
    ) const override;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<utility::string_t> getApps(
    ) const override;
    /// <summary>
    /// View notification
    /// </summary>
    ...
    /// <param name="appId"></param>
    /// <param name="notificationId"></param>
    pplx::task<std::shared_ptr<Notification>> getNotification(
        utility::string_t appId,
        utility::string_t notificationId
    ) const override;
    /// <summary>
    ...
    /// <param name="limit">How many notifications to return.  Max is 50.  Default is 50. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    /// <param name="limit">How many devices to return. Max is 300. Default is 300 (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    pplx::task<std::shared_ptr<Inline_response_200_3>> updatePlayerTags(
        utility::string_t appId,
        utility::string_t externalUserId,
        boost::optional<std::shared_ptr<Update_player_tags_request_body>> updatePlayerTagsRequestBody
    ) const override;
