...
#include "CppRestOneSignalAPIClient/model/AnyType.h"
...
public:
    ...
    /// </summary>
    utility::string_t getSendAfter() const;
    bool sendAfterIsSet() const;
    void unsetSend_after();

    void setSendAfter(const utility::string_t& value);
    ...
    /// </summary>
    utility::string_t getEmailSubect() const;
    bool emailSubectIsSet() const;
    void unsetEmail_subect();

    void setEmailSubect(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_Email_subect;
    bool m_Email_subectIsSet;
