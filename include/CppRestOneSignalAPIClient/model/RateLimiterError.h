...
#ifndef COM_ONESIGNAL_CLIENT_MODEL_RateLimiterError_H_
#define COM_ONESIGNAL_CLIENT_MODEL_RateLimiterError_H_
...
#endif /* COM_ONESIGNAL_CLIENT_MODEL_RateLimiterError_H_ */
