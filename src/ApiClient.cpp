...
std::shared_ptr<ApiConfiguration> ApiClient::getDefaultConfiguration() {
    const auto configuration = std::make_shared<ApiConfiguration>();
    configuration->setBaseUrl("https://onesignal.com/api/v1");
