...
public:
    ...
    MOCK_METHOD1( createPlayer, pplx::task<std::shared_ptr<Inline_response_200_4>> (
    ...
    MOCK_METHOD2( deletePlayer, pplx::task<std::shared_ptr<Inline_response_200_1>> (
        utility::string_t appId,
        utility::string_t playerId
    ) );
    MOCK_METHOD2( deleteSegments, pplx::task<std::shared_ptr<Inline_response_200_3>> (
        utility::string_t appId,
        utility::string_t segmentId
    ) );
    MOCK_METHOD2( exportPlayers, pplx::task<std::shared_ptr<Inline_response_200_5>> (
        utility::string_t appId,
    ...
    MOCK_METHOD0( getApps, pplx::task<utility::string_t> (
    ) );
    MOCK_METHOD2( getNotification, pplx::task<std::shared_ptr<Notification>> (
        utility::string_t appId,
        utility::string_t notificationId
    ) );
    ...
    MOCK_METHOD3( updatePlayerTags, pplx::task<std::shared_ptr<Inline_response_200_3>> (
        utility::string_t appId,
