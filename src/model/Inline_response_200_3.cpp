...
bool Inline_response_200_3::isSuccess() const
{
    return m_Success;
}

void Inline_response_200_3::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool Inline_response_200_3::successIsSet() const
{
    return m_SuccessIsSet;
}

void Inline_response_200_3::unsetSuccess()
{
    m_SuccessIsSet = false;
}
}
