...
utility::string_t Notification_allOf::getEmailSubject() const
{
    return m_Email_subject;
}

void Notification_allOf::setEmailSubject(const utility::string_t& value)
{
    m_Email_subject = value;
    m_Email_subjectIsSet = true;
}

bool Notification_allOf::emailSubjectIsSet() const
{
    return m_Email_subjectIsSet;
}

void Notification_allOf::unsetEmail_subject()
{
    m_Email_subjectIsSet = false;
}
