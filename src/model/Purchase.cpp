...
bool Purchase::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("iso"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_iso;
            ok &= ModelBase::fromJson(fieldValue, refVal_iso);
            setIso(refVal_iso);
        }
    }
    return ok;
...
bool Purchase::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        utility::string_t refVal_sku;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("sku"))), refVal_sku );
        setSku(refVal_sku);
    }
    ...
    {
        utility::string_t refVal_iso;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("iso"))), refVal_iso );
        setIso(refVal_iso);
    }
    return ok;
}
