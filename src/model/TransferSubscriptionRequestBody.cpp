...
void TransferSubscriptionRequestBody::validate()
{
    // TODO: implement validation
}

web::json::value TransferSubscriptionRequestBody::toJson() const
{
...
bool TransferSubscriptionRequestBody::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TransferSubscriptionRequestBody::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TransferSubscriptionRequestBody::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::map<utility::string_t, utility::string_t>& TransferSubscriptionRequestBody::getIdentity()
{
    return m_Identity;
}

void TransferSubscriptionRequestBody::setIdentity(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Identity = value;
    m_IdentityIsSet = true;
}

bool TransferSubscriptionRequestBody::identityIsSet() const
{
    return m_IdentityIsSet;
}

void TransferSubscriptionRequestBody::unsetIdentity()
{
    m_IdentityIsSet = false;
}
}
